        ...
        <div className='pt-6'>
            ...
            { !sucess && 
                <div className='w-1/5 mx-auto'>
                    ...
                    <label className='font-bold'>Whattsapp:</label>
                    <input type='text' className='p-4 block shadow bg-blue-100 my-2 rounded' placeholder='Whattsapp' onChange={onChange} name='Whattsapp' value={form.Whattsapp} />
                ...
                <p className='mb-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3'>Obrigado por contribuir com sua sugestão ou crítica.</p>
...

                    {
                        retorno.showCoupon && <div className='text-center border p-4 mb-4'>
                            ...
                            <br />
                            <span className='italic'>Tire um print ou foto deste tela e apresente ao garçom.</span>
                        </div>
                    }
                </div> 
            }
